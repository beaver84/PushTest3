...
class MyFirebaseMessagingService : FirebaseMessagingService() {
    ...
    override fun onMessageReceived(remoteMessage: RemoteMessage) {
        Log.d("remoteMessage.notification?.title token Log", "title token Log: $remoteMessage.notification?.title")
        Log.d("remoteMessage.notification?.body token Log", "body token Log: $remoteMessage.notification?.body")
